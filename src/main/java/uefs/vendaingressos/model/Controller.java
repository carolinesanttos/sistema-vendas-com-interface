...
/**
 * Classe que gerencia as operações do sistema de venda de ingressos.
 *
 * Permite cadastrar usuários e eventos, realizar login, alterar informações do usuário,
 * adicionar assentos, gerar ingressos, comprar ingressos, cancelar compras,
 * escolher e adicionar formas de pagamento, confirmar compras e dar feedbacks sobre eventos.
 * Também permite listar os eventos disponíveis e as formas de pagamento de um usuário.
 */
